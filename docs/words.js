...
export const WORD_PAIRS = [
  ...
  ["rallonge", "multiprise"],
  ["cuiseur", "réchaud"],
  ["bouilloire", "percolateur"],
  ["cafetière", "crêpière"],
  ["gaufrier", "hachoir"],
  ["serpillière", "étendoir"],
  ["sèche-linge", "radio"],
  ["chargeur", "rallonge"],
  ["multiprise", "néon"],
  // Outils et bricolage
  ...
  ["dirigeable", "parachute"],
  ["rover", "station"],
  ["météorite", "étoile"],
  ["cratère", "orbite"],
  ["trajectoire", "observatoire"],
  // Paysages
  ["montagne", "colline"],
  ["colline", "butte"],
  ["volcan", "geyser"],
  ...
  ["banquier", "caissier"],
  ["vendeur", "comptable"],
  ["archéologue", "météorologue"],
  ["chanteur", "chorégraphe"],
  ["réceptionniste", "animateur"],
  // Instruments
  ["piano", "clavecin"],
  ["clavecin", "orgue"],
  ["guitare", "banjo"],
  ...
  ["jardinerie", "quincaillerie"],
  ["vide-grenier", "restaurant"],
  ["brasserie", "cinéma"],
  ["théâtre", "musée"],
  ["gymnase", "piscine"],
  ["patinoire", "spa"],
