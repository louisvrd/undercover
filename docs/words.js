...
export const WORD_PAIRS = [
  ...
  ["plaque", "réchaud"],
  ["hotte", "ventilateur"],
  ["congélateur", "glacière"],
  ["sèche-linge", "étendoir"],
  ["aspirateur", "balai"],
  ["balai", "serpillière"],
  ["robot", "cireuse"],
  ...
  // Jardin
  ["arrosoir", "seau"],
  ["arrosoir", "pulvérisateur"],
  ["râteau", "pelle"],
  ["bêche", "fourche"],
  ["binette", "griffe"],
  ["sécateur", "cisaille"],
  ["cisaille", "taille-haie"],
  ...
  ["apiculteur", "pisciculteur"],
  ["mineur", "carrier"],
  ["pêcheur", "marin"],
  ["pompier", "secouriste"],
  ["militaire", "légionnaire"],
  ["douanier", "vigile"],
  ["juge", "avocat"],
  ["notaire", "huissier"],
  ["greffier", "procureur"],
  ...
  ["pilote", "steward"],
  ["aiguilleur", "contrôleur"],
  ["architecte", "ingénieur"],
  ["plombier", "électricien"],
  ["électricien", "chauffagiste"],
  ["maçon", "charpentier"],
  ...
  ["hennissement", "braiment"],
  ["meuglement", "bêlement"],
  ["gazouillis", "pépiement"],
  ["croassement", "caquètement"],
  ["sifflet", "cor"],
  ["chuchotement", "soupir"],
  ["applaudissement", "huée"],
  ["mélodie", "berceuse"],
  ["hymne", "marche"],
  // Mouvements
  ["chute", "glissade"],
  ...
  ["coupole", "monture"],
  ["oculaire", "miroir"],
  ["année-lumière", "parsec"],
  ["nébuleuse", "quasar"],
  // Danse
  ["salsa", "bachata"],
  ["rumba", "cha-cha"],
  ["flamenco", "sévillane"],
  ["claquettes", "charleston"],
  ["swing", "lindy"],
  ["hip-hop", "breakdance"],
  ...
  ["vitrine", "étagère"],
  ["bougeoir", "chandelier"],
  ["brûle-parfum", "diffuseur"],
  ["sculpture", "totem"],
  ["terrarium", "aquarium"],
  ["mobile", "attrape-rêves"],
  // Bricolage : mesures
  ["centimètre", "pouce"],
  ["gramme", "once"],
  ["litre", "pinte"],
  ...
  ["brogue", "monk"],
  ["chelsea", "jodhpur"],
  ["compensée", "plateforme"],
  ["stiletto", "kitten"],
  ["trotteur", "derby"],
  ["cuissarde", "bottillon"],
  ["après-ski", "raquette"],
  ["charentaise", "babouche"],
  ["tannerie", "mégisserie"],
  ["croûte", "nubuck"],
  ["embauchoir", "chausse-pied"],
  ["trépointe", "contrefort"],
  ["bride", "salomé"],
  // Petits objets
  ["décapsuleur", "ouvre-boîte"],
  ["presse-ail", "dénoyauteur"],
  ["entonnoir", "louche"],
  ["écumoire", "araignée"],
  ["pilon", "fouet"],
  ["moulinette", "hachoir"],
  ...
  // Sur la route
  ["autoroute", "nationale"],
  ["départementale", "chemin"],
  ["bretelle", "échangeur"],
  ["glissière", "muret"],
  ["ralentisseur", "chicane"],
  ["borne", "kilomètre"],
  ...
  ["guérite", "tourelle"],
  ["halle", "arcade"],
  ["estaminet", "guinguette"],
  ["pension", "villégiature"],
  ["hameau", "bourg"],
  ["faubourg", "quartier"],
  // Encore des mots
  ["linteau", "seuil"],
  ...
  ["dépôt", "triage"],
  ["tender", "fourgon"],
  ["terminus", "correspondance"],
  // Sensations et perceptions
  ["chaleur", "moiteur"],
  ["froid", "engourdissement"],
  ["fatigue", "courbature"],
